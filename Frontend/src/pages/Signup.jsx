...
import { creatingAccount } from "../features/signupSlice";
...
const Signup = () => {
  ...
  return (
    <div className="signupCon lg:h-[100vh] w-[100%] flex flex-col items-center justify-center font-roboto">
      ...
      <div className=" w-[100%] flex lg:items-center justify-evenly max-lg:mt-[70px]">
        <h1 className="text-[22px] max-lg:hidden">
          Welcome To Our Platform, Signup To Use The Platform
        </h1>
        <form
          onSubmit={onsubmit}
          action=""
        ...
        >
          ...
          <Button value="Agree & Signup" apidata={apidata} />
          <Line />
          <h2 className="text-center mb-8">
            Have A Account?{" "}
            <Link to="login" className="text-[#0a7dd3]">
              Sign In
            </Link>
          </h2>
        </form>
